...
| **Total_Costs** | Float | Total annual electricity costs for the facility including EV operations. Formulated as: $Reference\_Cost - Arbitrage\_Value + Battery\_Degradation\_Costs - Peak\_Reduction\_Savings$ | `3,228.0` |
...
| **Net_Compensation** | Float | Total financial difference between baseline and V2G operational costs ($Reference\_Cost - Total\_Costs$) (€). | `314.67` |
| **Profit_Company** | Float | Net economic profit remaining for the corporate facility, calculated as: $Net\_Compensation + Battery\_Degradation\_Costs$ (€). | `1294.63` |
